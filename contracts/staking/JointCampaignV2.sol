...
contract JointCampaignV2 is Ownable {
    ...
    event StateContractApproved(address _stateContract);
        ...
        returns (bool)
    {
        ...
        IMozartCoreV2 stateContract = IMozartCoreV2(_stateContract);
        ...
        updateReward(msg.sender, address(0))
    {
        ...
        require(
            staker.stateContract == address(0) || staker.stateContract == _stateContract,
        ...
        if (staker.stateContract == address(0)) {
            staker.stateContract = _stateContract;
        }
