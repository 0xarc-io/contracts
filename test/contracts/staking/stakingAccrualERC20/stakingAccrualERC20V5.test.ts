...
import checkStakedBalance from './checkStakedBalance';
import createStream from '../../../helpers/createSablierStream';
  ...
  describe('Base functionality tests', () => {
    ...
    describe('Scenarios', () => {
      ...
      it('Two players with admin', async () => {
        ...
        await checkStakedBalance(contract, user1);
      });
      ...
      it('Complex scenario', async () => {
        ...
        await checkState('1', '300', '300');
        await checkStakedBalance(contract, user1);
        await checkStakedBalance(contract, user2);
