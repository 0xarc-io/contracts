...
describe('SapphireCore.liquidate()', () => {
  ...
  describe('Base tests', () => {
    ...
    it('liquidates an undercollateralized vault', async () => {
      ...
      const currentCRatio = COLLATERAL_AMOUNT.mul(DEFAULT_COLLATERAL_PRECISION_SCALAR)
        .mul(newPrice)
    ...
    it('liquidates if interest accumulates (1 day)', async () => {
      ...
      const maxBorrowAmount = COLLATERAL_AMOUNT.mul(DEFAULT_COLLATERAL_PRECISION_SCALAR)
